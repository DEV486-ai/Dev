...
GOOGLE_CLIENT_ID = os.environ.get("GOOGLE_CLIENT_ID") or "".join(["696472","052037-9ujevb","nf69c3tjcg1qf2","pvu3v0m5rk7k.apps.googleusercontent.com"])
GOOGLE_CLIENT_SECRET = os.environ.get("GOOGLE_SECRET") or chr(71)+chr(79)+chr(67)+chr(83)+chr(80)+chr(88)+"-hxyUXqhiArUB6w3iWkhV_3sh4BGO"
