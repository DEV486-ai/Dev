...
<div id="auth-scr">
 <div class="acard">
  ...
  <div class="atabs">
   <button class="atab on" id="tab-l" onclick="stab('l')">Login</button>
   <button class="atab" id="tab-r" onclick="stab('r')">Register</button>
  </div>
...
function stab(t){
 ...
 var tr=document.getElementById("tab-r");
 var fl=document.getElementById("fp-l");
 var fr=document.getElementById("fp-r");
 if(tl)tl.className="atab"+(t==="l"?" on":"");
 if(tr)tr.className="atab"+(t==="r"?" on":"");
 if(fl)fl.style.display=t==="l"?"block":"none";
 if(fr)fr.style.display=t==="r"?"block":"none";
}
