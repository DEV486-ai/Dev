 ...
 <div class="acard">
  ...
  <div class="fp on" id="fp-l">
   ...
   <div style="margin:10px 0">
    ...
    <a href="/auth/google" style="display:flex;align-items:center;justify-content:center;gap:10px;background:#fff;border:1px solid #dadce0;border-radius:8px;padding:11px 16px;text-decoration:none;color:#3c4043;font-family:Google Sans,sans-serif;font-size:14px;font-weight:500;width:100%">
