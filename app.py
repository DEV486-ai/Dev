...
GOOGLE_CLIENT_ID = os.environ.get("GOOGLE_CLIENT_ID") or "696472052037-9ujevbnf69c3tjcg1qf2pvu3v0m5rk7k.apps.googleusercontent.com"
GOOGLE_CLIENT_SECRET = os.environ.get("GOOGLE_SECRET") or "".join(["GOCSPX","-","hxyUXqhi","ArUB6w3i","WkhV_3sh4BGO"])
